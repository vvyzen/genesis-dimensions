...
import vvyzen.genesismod.client.renderer.sky.PurgatorySkyRenderer;

import javax.annotation.Nullable;

@OnlyIn(Dist.CLIENT)
public class PurgatoryRenderInfo extends DimensionSpecialEffects {
    private ISkyRenderHandler skyRenderer;

    public PurgatoryRenderInfo() {
    ...
    public ISkyRenderHandler getSkyRenderHandler() {
        if (this.skyRenderer == null)
            this.skyRenderer = new PurgatorySkyRenderer();
