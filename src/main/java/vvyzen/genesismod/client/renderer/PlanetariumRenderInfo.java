...
import vvyzen.genesismod.client.renderer.sky.PlanetariumSkyRenderer;

import javax.annotation.Nullable;

@OnlyIn(Dist.CLIENT)
public class PlanetariumRenderInfo extends DimensionSpecialEffects {
    private ISkyRenderHandler skyRenderer;

    public PlanetariumRenderInfo() {
    ...
    public ISkyRenderHandler getSkyRenderHandler() {
        if (this.skyRenderer == null)
            this.skyRenderer = new PlanetariumSkyRenderer();
