...
import vvyzen.genesismod.client.renderer.sky.TethysSkyRenderer;

import javax.annotation.Nullable;

@OnlyIn(Dist.CLIENT)
public class TethysRenderInfo extends DimensionSpecialEffects {
    private ISkyRenderHandler skyRenderer;

    public TethysRenderInfo() {
    ...
    public ISkyRenderHandler getSkyRenderHandler() {
        if (this.skyRenderer == null)
            this.skyRenderer = new TethysSkyRenderer();
