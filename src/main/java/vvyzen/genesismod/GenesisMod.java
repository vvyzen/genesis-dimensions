...
import vvyzen.genesismod.client.KeyMappings;
import vvyzen.genesismod.client.renderer.*;
...
public class GenesisMod
{
    ...
    private void setup(final FMLCommonSetupEvent event)
    {
        ...
        DimensionSpecialEffects.EFFECTS.put(new ResourceLocation("ssvrfi", "purgatory"), new PurgatoryRenderInfo());
