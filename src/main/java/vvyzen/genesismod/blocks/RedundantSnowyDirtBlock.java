...
public abstract class RedundantSnowyDirtBlock extends SnowyDirtBlock {
    protected RedundantSnowyDirtBlock(BlockBehaviour.Properties p_56817_) {
        super(p_56817_);
    }
    ...
    public void randomTick(BlockState p_56819_, ServerLevel p_56820_, BlockPos p_56821_, Random p_56822_) {
        if (!canBeGrass(p_56819_, p_56820_, p_56821_)) {
            ...
            p_56820_.setBlockAndUpdate(p_56821_, BlockRegistry.SULPHURIC_SOIL.get().defaultBlockState());
        } else {
            if (p_56820_.getMaxLocalRawBrightness(p_56821_.above()) >= 9) {
                ...
                for(int i = 0; i < 4; ++i) {
                    ...
                    if (p_56820_.getBlockState(blockpos).is(BlockRegistry.SULPHURIC_SOIL.get()) && canPropagate(blockstate, p_56820_, blockpos)) {
