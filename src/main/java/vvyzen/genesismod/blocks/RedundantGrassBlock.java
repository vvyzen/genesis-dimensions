...
public class RedundantGrassBlock extends RedundantSnowyDirtBlock implements BonemealableBlock {
    public RedundantGrassBlock(BlockBehaviour.Properties p_53685_) {
        super(p_53685_);
    }
