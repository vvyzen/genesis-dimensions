...
public class FluidRegistry {
    public static DeferredRegister<Fluid> FLUIDS = DeferredRegister.create(ForgeRegistries.FLUIDS, GenesisMod.MODID);

    //fuck
    public static final RegistryObject<BloodFluid.Flowing> FLOWING_BLOOD = FLUIDS.register("flowing_blood", BloodFluid.Flowing::new);
    public static final RegistryObject<BloodFluid.Source> BLOOD_SOURCE = FLUIDS.register("blood_source", BloodFluid.Source::new);
